 ...
 * @author P D R Deshan
 */
public class EventOrderDashboard extends javax.swing.JFrame {

    Employee emp;
    /**
     * Creates new form CustomerReg
     */
    public EventOrderDashboard() {
        initComponents();
        popTableAndCount();
    }
    
     public EventOrderDashboard(Employee emp) {
        initComponents();
    ...
    private void initComponents() {
        ...
        jTable1.setModel(new javax.swing.table.DefaultTableModel(
            ...
            new String [] {
                "Event ID", "Event Name", "Type", "Date", "Customer Email"
            }
        ) {
        ...
        jLabel10.setText("Events Details");
    ...
    private void jButton7ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton7ActionPerformed
         try {
            ...
            String Eid = model.getValueAt(selectrw, 0).toString();
    ...
    private void jButton6ActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_jButton6ActionPerformed
        ...
        int selectrw = jTable1.getSelectedRow();
        String Eid = model.getValueAt(selectrw, 0).toString();
        String Cemail = model.getValueAt(selectrw, 4).toString();
        System.out.println("Eid view " +Eid );
        
        dispose();
        new DashboardViewEvent(Eid,Cemail).setVisible(true);
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(EventOrderDashboard.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
     ...
     public void popTableAndCount(){
        ...
        try {
            ...
            count.setText(String.valueOf(srv.getTotalEventCount()));
            ...
            ArrayList<Event> array = srv.getAllEventList();
            ...
            for(int i=0; i<array.size();i++){
                ...
                rawdata[4]=array.get(i).getCemail();
